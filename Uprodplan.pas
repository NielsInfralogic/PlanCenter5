          ...
          begin
            ...
            begin
              ...
              begin
                ...
                // pairpos num bruges den til at sætte ind i ip
                DataM1.Query1.sql.add
    ...
    begin
      ...
      Begin
        Case Plate.Pages[ip].pagetype of
          ...
          begin // den bør ikke komme her til
          end;
...
begin
  ...
  try
    ...
    if Editmode = PLANADDMODE_APPLY then
    begin // den bliver applyet så den har allerede et productionnames og id
    end
    else
    begin
      plateframesproductionid := -1;
  ...
  firstcolor: Boolean;
          ...
          Begin
            ...
            begin
              ...
              DataM1.Query3.sql.add(',copynumber = ' +  inttostr(plateframesdata[iplf].ProdPlates[ipl].Copynumber + extracopyoffset)); // her skal gøres noget
...
begin
  ...
  try
                ...
                begin
                  ...
                  Begin
                    Foundlevel := findpagerunnig(plateframeslocationid,
                      ...
                      plateframesdata[iplf].ProdPlates[ipl].Pages[ip].pagename,
                      plateframesdata[iplf].ProdPlates[ipl].Pages[ip].colors[ic].ColorID,
                      plateframesdata[iplf].ProdPlates[ipl].Copynumber + extracopyoffset, // her skal gøres noget
                      iplf, ipl,
        ...
        begin
          ...
          Begin
            ...
            begin
              ...
              begin
                // af en eller anden grund havde jeg ikke bare copyseparationset dette har noget at gøre med at siderne kan være fra andet site.
    ...
    // sætter status, anden master baseret data
  ...
  try
    ...
    begin
      ...
      begin
        ...
        plateframesdata[iplf].ProdPlates[NProdPlates].totappr := 0; // sæt
        plateframesdata[iplf].ProdPlates[NProdPlates].totstat := 0; // sæt
...
Begin
  ...
  (*
    ...
    PaginationMode=0: Pagination starter forfra for hver sektion, uafhængigt af om udskydning er inserted eller ej A1=1..A16=16,B1=1…
    PaginationMode=1: Pagination er gennemløbende gennem alle sektioner som inserted. A1=1..A8=8,B1=9..B16=24,A9=25…
    PaginationMode=2: Pagination er gennemløbende gennem alle sektioner som consecutivt  A1=1.. A16=16,B1=17….B16=32
    Platename (MiscString1) er altid laveste pagination på hver plade. Hvis der er custom-shit skal det laves i spImportCenterPressRunCustom
  *)
