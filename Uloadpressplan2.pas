...
type
  TFormloadpressplan2 = class(TForm)
    Panel1: TPanel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    Panel3: TPanel;
...
var
  Formloadpressplan2: TFormloadpressplan2;
...
procedure TFormloadpressplan2.Autosetifone;
Var
  secid,i : Integer;
  Nsecs   : Integer;
  Neds : Integer;
...
procedure  TFormloadpressplan2.FillPublicationCombo();
begin
...
procedure TFormloadpressplan2.Init();
Var
  deadl : Tdatetime;
  Year, Month, Day: Word;
//  i : Longint;
...
procedure TFormloadpressplan2.SetEditionCombo;
var
...
procedure TFormloadpressplan2.BitBtn1Click(Sender: TObject);
Var
...
procedure TFormloadpressplan2.FormCreate(Sender: TObject);
Var
  I : Longint;
begin
  defaultpublid := 0;
...
procedure TFormloadpressplan2.DateTimePicker1loadplanChange(Sender: TObject);
begin
  makeplanname;
...
procedure TFormloadpressplan2.SetPublicationSpecificTemplate();
var
  templateName : string;
begin
   templateName := '';
...
procedure TFormloadpressplan2.SetPublicationSpecificPriority();
begin
...
procedure TFormloadpressplan2.ComboBoxpublicationChange(Sender: TObject);
Var
  i,
  deftmplid : longint;
...
{Function TFormloadpressplan2.DateOfWeek(Year : Word;
                                       Week : Word;
                                       DayOfWeek : Word;
                                       Var Day : Word;
                                       Var Month : Word):Longint;
...
procedure TFormloadpressplan2.ComboBoxpresstemplatenameChange(
  Sender: TObject);
Var
  id,i : Integer;
begin
...
Procedure TFormloadpressplan2.setposibletemplates(ShowAll:Boolean);
Var
...
procedure TFormloadpressplan2.ListBoxpresstemplatenameClick(Sender: TObject);
Begin
  Sectionschanged := false;
  Editionchanged  := false;
  Offsetchanged   := false;
...
Procedure TFormloadpressplan2.SetListData;
Var
  l : tlistitem;
  I,i2 : Longint;
  T : string;
...
procedure TFormloadpressplan2.FormActivate(Sender: TObject);
...
Procedure TFormloadpressplan2.loadAvailplans;
Var
  I : Longint;
begin
  try
...
procedure TFormloadpressplan2.CheckBoxshowallClick(Sender: TObject);
begin
  loadplanlist;
end;

// Populate press template list  for 'selectedpressID'
Procedure TFormloadpressplan2.loadplanlist;
...
procedure TFormloadpressplan2.ComboBoxpublfiltChange(Sender: TObject);
begin
  loadplanlist;
end;

procedure TFormloadpressplan2.ComboBoxEditionSelectionChange(Sender: TObject);
begin
...
procedure TFormloadpressplan2.ComboBoxNpageChange(Sender: TObject);
begin
  loadplanlist;
end;

procedure TFormloadpressplan2.EditcreepExit(Sender: TObject);
Var
  crp : Double;
  res : Boolean;
begin
...
procedure TFormloadpressplan2.Button1Click(Sender: TObject);
Var
...
Procedure TFormloadpressplan2.makeplanname;
begin
...
procedure TFormloadpressplan2.PopupDeletePlanClick(Sender: TObject);
...
procedure TFormloadpressplan2.PopupEditPlanNameClick(Sender: TObject);
var
  PressPlanNameOld,
...
procedure TFormloadpressplan2.ButtoneditClick(Sender: TObject);
Var
  I,i2 : longint;
  l : tlistitem;
  Nchecked : Integer;
...
procedure TFormloadpressplan2.changesectionname1Click(Sender: TObject);
begin
...
procedure TFormloadpressplan2.Changeeditionname1Click(Sender: TObject);
begin
...
procedure TFormloadpressplan2.EditweekChange(Sender: TObject);
Var
...
begin
  ...
  if StrToInt(editweek.Text) < 1 then exit;
  if StrToInt(editweek.Text) > 52 then exit;
...
procedure TFormloadpressplan2.Button2Click(Sender: TObject);
begin
...
procedure TFormloadpressplan2.CheckBoxChangecopiesClick(Sender: TObject);
begin
  EditCopies.Enabled := CheckBoxChangecopies.Checked;
  UpDownCopies.Enabled := CheckBoxChangecopies.Checked;
end;

procedure TFormloadpressplan2.CheckBoxOnlyShowDefaultPressPublicationsClick(Sender: TObject);
begin
   FillPublicationCombo();
end;

procedure TFormloadpressplan2.autosetCurrentproddata;
Var
  L            : Tlistitem;
  T            : string;
  contOK       : boolean;
...
procedure TFormloadpressplan2.Changeoffset1Click(Sender: TObject);
begin
...
procedure TFormloadpressplan2.CheckBoxusecurprodClick(Sender: TObject);
begin
  if ListBoxpresstemplatename.itemindex < 0 then exit;
...
procedure TFormloadpressplan2.setapplyeds;
Var
  I : Longint;
  Npteds : Longint;
...
procedure TFormloadpressplan2.setapplysec;
var
  asec,Nsec : Integer;
Begin
...
Procedure TFormloadpressplan2.Setdeadl;
var
  a : TDateTime;
Begin
...
procedure TFormloadpressplan2.Button3Click(Sender: TObject);
begin
  if PBExListview1.Selected = nil then exit;
  if FormChangesectionnamebyload.ShowModal = mrok then
  begin
...
procedure TFormloadpressplan2.ComboBoxtemplateChange(Sender: TObject);
begin
  CheckIfReady;
end;

procedure TFormloadpressplan2.CheckIfReady;
begin
